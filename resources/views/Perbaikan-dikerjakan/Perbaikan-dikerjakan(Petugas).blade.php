            ...
            <tbody>
                @foreach ($pengaduans as $index => $item)
                    <tr class="border-t align-middle">
                        ...
                        <td class="px-4 py-3 text-left">
                            <a href="{{ route('Perbaikan.dikerjakan.detail.petugas', ['id' => $item->id]) }}" class="text-blue-600 hover:underline">Lihat detail</a>
                        </td>
                        <td class="px-4 py-3 text-left">
                            <span class="bg-yellow-400 text-black text-xs font-bold px-3 py-1 rounded-full inline-block">
                                {{ $item->status }}
                            </span>
                        </td>
                        <td class="px-4 py-3 text-left">
                        ...
                        <td class="px-4 py-3 text-left">
                            @if($item->status != 'Selesai')
                                <a href="{{ route('progres.form', ['pengaduan' => $item->id]) }}" class="text-orange-600 hover:underline font-semibold">Tambah Progres</a>
                            @endif
                        </td>
                    </tr>
                @endforeach
