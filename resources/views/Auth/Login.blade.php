...
<body class="bg-black">
  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-1/2 bg-yellow-400 flex items-center justify-center">
      <form method="POST" action="{{ route('Login') }}" class="bg-white rounded-3xl shadow-lg p-8 w-[90%] max-w-sm">
        @csrf
        ...
        <div class="text-xs text-right mb-4">
          Belum punya akun? <a href="{{ route('Register') }}" class="text-[#FF6600] hover:underline font-bold">Daftar</a>
        </div>
