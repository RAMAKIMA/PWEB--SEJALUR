...
<body class="font-sans text-white">
    ...
    <div class="relative flex flex-col items-center justify-center text-center">
        <h1 class="text-5xl font-bold pt-28">Perbaikan</h1>
        <p class="text-2xl font-light pt-4 text-center tracking-[.5em]">Selesai</p>
                ...
                @foreach ($pengaduans as $index => $item)
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-3 text-blue-600 underline text-left">
                            <a href="{{ route('Perbaikan.selesai.detail.masyarakat', ['id' => $item->id]) }}">Lihat detail</a>
                        </td>
                        <td class="px-4 py-3 text-left">
