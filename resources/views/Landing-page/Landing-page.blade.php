...
<body class="bg-black text-white">
    ...
    <ul class="flex gap-6 font-semibold ml-7 items-center">
        <li><a href="{{ route('Login') }}" class="hover:underline">Pengaduan</a></li>
        ...
        <ul id="dropdownMenu" class="hidden absolute bg-white text-black mt-2 shadow-lg rounded-lg z-50 w-48">
            <li>
            <a href="{{ route('Login') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-lg">Dikerjakan</a>
            </li>
            <li>
            <a href="{{ route('Login') }}" class="block px-4 py-2 hover:bg-gray-100 rounded-lg">Selesai</a>
            </li>
        </ul>
        </li>

        <li><a href="{{ route('Login') }}" class="hover:underline">Dashboard</a></li>
    </ul>

    <div class="flex items-center gap-4 mr-10 font-semibold">
        <a href="{{ route('Register') }}" class="hover:underline">Sign Up</a>
        <span>|</span>
        <a href="{{ route('Login') }}" class="bg-black text-white px-4 py-2 rounded-full hover:bg-[#171C22]">Sign In</a>
    </div>
    </nav>
