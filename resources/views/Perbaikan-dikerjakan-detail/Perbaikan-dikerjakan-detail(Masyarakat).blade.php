...
<body class="bg-gray-100 font-sans">
  ...
  <div class="max-w-3xl mx-auto mt-10 bg-white p-8 rounded shadow">
    <h2 class="text-2xl font-bold mb-6">Detail Perbaikan</h2>
    ...
    <!-- Kolom Kiri -->
        ...
        <div class="md:w-1/2">
            <label class="block font-medium text-sm mb-1 text-gray-700">Foto Kerusakan<span class="text-red-500">*</span></label>
            <img src="{{ asset('storage/' . $pengaduan->foto_kerusakan) }}" alt="Foto Pengaduan" class="w-full rounded shadow border">
        </div>
        @endif
        </div>

        <div>
            <a href="{{ route('Perbaikan.dikerjakan.masyarakat') }}" class="inline-block mt-4 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded-md ml-[38em]">
            Kembali
            </a>
        </div>
    </div>
