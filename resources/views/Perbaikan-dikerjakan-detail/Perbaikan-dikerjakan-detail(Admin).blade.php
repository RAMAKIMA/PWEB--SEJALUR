...
<body class="bg-gray-100 font-sans">
  ...
  <div class="max-w-3xl mx-auto mt-10 bg-white p-8 rounded shadow">
    ...
    <!-- Kolom Kiri -->
        ...
        <div>
            <a href="{{ route('Perbaikan.dikerjakan.admin') }}" class="inline-block mt-4 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded-md ml-[38em]">
            Kembali
            </a>
        </div>
    </div>
