...
<body class="font-sans text-white">
                ...
                <?php $__currentLoopData = $pengaduans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-3 text-blue-600 hover:underline text-left">
                            <a href="<?php echo e(route('Pengaduan.detail.masyarakat', ['id' => $item->id])); ?>">Lihat detail</a>
                        </td>
    ...
    <a href="<?php echo e(route('Form.pengaduan')); ?>" class="absolute right-[17.2em] top-40">
        <button class="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-1 px-4 rounded-full shadow-lg">
        + Pengaduan
        </button>
    </a>
    </section>
...
<?php /**PATH C:\laragon\www\PWEB\resources\views/Pengaduan/Pengaduan(Masyarakat).blade.php ENDPATH**/ ?>