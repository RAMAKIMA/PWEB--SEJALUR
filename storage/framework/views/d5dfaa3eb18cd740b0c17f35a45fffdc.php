            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-3 text-blue-600 hover:underline text-left">
                        <a href="<?php echo e(route('Pengaduan.detail.admin', ['id' => $pengaduan->id])); ?>">Lihat detail</a>
                    </td>
                    ...
                    <td class="px-4 py-3 text-left">
                        <form method="POST" action="<?php echo e(route('pengaduan.updatePetugas', $pengaduan->id)); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <select name="petugas" onchange="this.form.submit()"
                                ...
                                <?php $__currentLoopData = $petugasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $petugas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="bg-white" value="<?php echo e($petugas); ?>" <?php echo e($pengaduan->petugas == $petugas ? 'selected' : ''); ?>>
                                        <?php echo e($petugas); ?>
...
<?php /**PATH C:\laragon\www\PWEB\resources\views/Pengaduan/Pengaduan(Admin).blade.php ENDPATH**/ ?>