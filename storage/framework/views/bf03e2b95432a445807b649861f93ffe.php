...
<body class="bg-white text-black">
    ...
    <div class="p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 pl-60 pr-60">
            ...
            <p class="text-lg"><?php echo e($belumDiperbaiki); ?> Jalan</p>
            </div>
            ...
            <p class="text-lg"><?php echo e($sedangDiperbaiki); ?> Jalan</p>
            </div>
            ...
            <p class="text-lg"><?php echo e($selesai); ?> Jalan</p>
            </div>
        </div>
        ...
        <div class="relative flex flex-col items-center justify-center text-center">
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                <?php $__currentLoopData = $pengaduans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t">
                    <td class="px-4 py-3 text-left bg-gray-100"><?php echo e($index + 1); ?></td>
                    <td class="px-4 py-3 text-left"><?php echo e($item->jenis_kerusakan); ?></td>
                    <td class="px-4 py-3 text-left">
                        <a href="<?php echo e($item->lokasi_kerusakan); ?>" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:underline">
                        <?php echo e($item->lokasi_kerusakan); ?>

                        </a>
                    </td>
                    <td class="px-4 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($item->tanggal_pengaduan)->format('d-m-Y')); ?></td>
                    ...
                    <td class="px-4 py-3 text-left">
                        ...
                        ?>
                        <span class="<?php echo e($statusColor); ?> text-xs font-bold px-3 py-1 rounded-full">
...
<?php /**PATH C:\laragon\www\PWEB\resources\views/Dashboard/Dashboard(Admin).blade.php ENDPATH**/ ?>