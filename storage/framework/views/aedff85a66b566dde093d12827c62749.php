...
<body class="bg-black">
  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-1/2 bg-yellow-400 flex items-center justify-center">
      <form method="POST" action="<?php echo e(route('Register')); ?>" class="bg-white rounded-3xl shadow-lg p-8 w-[90%] max-w-md">
        <?php echo csrf_field(); ?>
        ...
        <div class="text-xs text-right mb-4">
          Sudah punya akun? <a href="<?php echo e(route('Login')); ?>" class="text-[#FF6600] hover:underline font-bold">Login</a>
        </div>
...
<?php /**PATH C:\laragon\www\PWEB\resources\views/Auth/Register.blade.php ENDPATH**/ ?>